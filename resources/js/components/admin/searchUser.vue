       ...
       <div class="row">
          ...
          <div class="col-6 float-right mt-3">
           <div class="row float-right">
                ...
                <button type="button" class="btn btn-primary col-2 p-1">
...
export default {
     data() {
        ...
        methods: {
            ...
            getResults(page_url='/api/user/search') {
            let vm = this;
            axios.get(page_url)
                .then(res=>res.data)
                .then(res => {
             ...
             makePagination(meta) {
                this.pagination = {
                    ...
                    current_page_url: 'http://localhost:8000/api/user/search/?page=' + meta.current_page,
